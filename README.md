# ![Grappling hook](icon.png) Git Hooks Dispatcher [![Build Status](https://travis-ci.org/whiskeysierra/git-hooks-dispatcher.png?branch=master,develop)](http://travis-ci.org/whiskeysierra/git-hooks-dispatcher)
